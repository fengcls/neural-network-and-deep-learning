...
def test_rnnslu(**kwargs):
    ...
    param_str = ('_f' + str(param['fold']) +
                 '_lr' + str(param['lr'])[1:5].replace('.', '') + 
                 '_d' + str(param['decay']) +
                 '_w' + str(param['win']) +
                 '_nh' + str(param['nhidden']) +
                 '_s' + str(param['seed']) + 
                 '_ed' + str(param['emb_dimension']) +
                 '_ne' + str(param['nepochs']) +
                 '_normal' + str(param['normal']))
    ...
    for e in range(param['nepochs']):
        ...
        res_test = conlleval(predictions_test,
                             groundtruth_test,
                             words_test,
                             param['folder'] + '/current.test'+param_str+'.txt',
                             param['folder'])
        res_valid = conlleval(predictions_valid,
                              groundtruth_valid,
                              words_valid,
                              param['folder'] + '/current.valid'+param_str+'.txt',
                              param['folder'])
        ...
        if res_valid['f1'] > best_f1:
            ...
            os.rename(param['folder'] + '/current.test'+param_str+'.txt',
                      param['folder'] + '/best.test'+param_str+'.txt')
            os.rename(param['folder'] + '/current.valid'+param_str+'.txt',
                      param['folder'] + '/best.valid'+param_str+'.txt')
        else:
            if param['verbose']:
                print('')
...
def test_rnnslu2(**kwargs):
    ...
    param_str = ('_f' + str(param['fold']) +
                 ...
                 '_d' + str(param['decay']) +
                 '_w' + str(param['win']) +
                 '_nh1' + str(param['nhidden1']) +
                 '_nh2' + str(param['nhidden2']) +
                 '_s' + str(param['seed']) + 
                 '_ed' + str(param['emb_dimension']) +
                 '_ne' + str(param['nepochs']) +
                 '_normal' + str(param['normal']))
